...
TEST_F(RendererTest_UsesSDL, createTexture)
{
...
TEST_F(RendererTest_UsesSDL, renderPresent)
{
	r.renderPresent();
}

TEST_F(RendererTest_UsesSDL, setLogicalSize)
{
	r.setLogicalSize({100, 50});
	auto expected = Dimension{100, 50};
